...
def _get_regular_prompts(qn: str) -> List[str]:
    ...
    # TODO: this were artyoms prompts, we are adding them in an upstream call now instead.
    # Delete the commented prompts from here at some point.
    ...
    prompt_fn_list = [prompt1_fn, prompt2_fn, prompt3_fn]
...
def get_all_generated_prompts(question: str) -> List[str]:
